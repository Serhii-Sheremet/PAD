...
CREATE TABLE IF NOT EXISTS SHUNYA
(
	ID INTEGER PRIMARY KEY AUTOINCREMENT,
	ZODIAKID INTEGER,
...
(
	...
	NAME TEXT,
	LANGUAGECODE VARCHAR(2),
	FOREIGN KEY (SHUNYAID) REFERENCES SHUNYA (ID)
);
...
CREATE TABLE IF NOT EXISTS JOGA_DESC
(
	ID INTEGER PRIMARY KEY AUTOINCREMENT,
	JOGAID INTEGER,
	NAME TEXT,
	...
	DESCRIPTION TEXT,
	LANGUAGECODE VARCHAR(2),
	FOREIGN KEY (JOGAID) REFERENCES JOGA (ID)
);
...
CREATE TABLE IF NOT EXISTS NITYAJOGA
(
	ID INTEGER PRIMARY KEY AUTOINCREMENT,
	NJCODE TEXT,
	COLORID INTEGER,
	NAKSHATRAID INTEGER,
	JOGIPLANETID INTEGER,
	AVAJOGIPLANETID INTEGER,
	FOREIGN KEY (COLORID) REFERENCES COLORS (ID),
	FOREIGN KEY (NAKSHATRAID) REFERENCES NAKSHATRA (ID),
	FOREIGN KEY (JOGIPLANETID) REFERENCES PLANET (ID),
	FOREIGN KEY (AVAJOGIPLANETID) REFERENCES PLANET (ID)
);

CREATE TABLE IF NOT EXISTS NITYAJOGA_DESC
(
	ID INTEGER PRIMARY KEY AUTOINCREMENT,
	NITYAJOGAID INTEGER,
	NAME TEXT,
	...
	DESCRIPTION TEXT,
	LANGUAGECODE VARCHAR(2),
	FOREIGN KEY (NITYAJOGAID) REFERENCES NITYAJOGA (ID)
);
...
CREATE TABLE IF NOT EXISTS JNDATA
(
	DATECHANGE VARCHAR(20),
	LONGITUDE TEXT,
	NAKSHATRAID INTEGER,
