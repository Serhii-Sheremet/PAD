namespace PAD
{
    public static class EpheConstants
    {
        ...
        public const int SE_MEAN_NODE = 10; // Rahu and +-180 = Ketu
        ...
        public const int SEFLG_SPEED3 = 128;                                     // speed from 3 positions (do not use it, SEFLG_SPEED is faster and preciser.) 
        ...
        public const int SEFLG_ASTROMETRIC = (SEFLG_NOABERR | SEFLG_NOGDEFL);    // astrometric positions i.e. with light-time, but without aberration and light deflection
        ...
        public const int SEFLG_ORBEL_AA = SEFLG_TOPOCTR;                         // used for Astronomical Almanac mode in calculation of Kepler elipses
        ...
        public const int SEFLG_DPSIDEPS_1980 = (256 * 1024);                     // reproduce JPL Horizons; 1962 - today to 0.002 arcsec. 
        ...
        public const int SE_SIDM_GALCENT_RGBRAND = 30;
