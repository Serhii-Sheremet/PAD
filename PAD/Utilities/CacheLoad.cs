...
namespace PAD
{
    public static class CacheLoad
    {
        ...
        public static List<PlanetData> _pdBirthList;
        public static double _bithAscendant;
        public static int _birthZodiakMoonId;
        public static int _birthNakshatraMoonId;
        public static int _birthPadaMoonNumber;
        public static int _birthLagnaId;
        public static int _birthNakshatraLagnaId;
        public static int _birthPadaLagnaNumber;
        ...
        public static List<Profile> GetProfilesList()
        {
            ...
            using (SQLiteConnection dbCon = Utility.GetSQLConnection())
            {
                ...
                try
                {
                    string comm = "select ID, PROFILENAME, PERSONNAME, PERSONSURNAME, DATEOFBIRTH, PLACEOFBIRTHID, PLACEOFLIVINGID, MESSAGE, CHECKED from PROFILE order by ID";
                    SQLiteCommand command = new SQLiteCommand(comm, dbCon);
                    using (SQLiteDataReader reader = command.ExecuteReader())
                    {
                        if (reader.HasRows)
                        {
                            while (reader.Read())
                            {
                                Profile temp = new Profile
                                {
                                    ...
                                    Message = reader.StringValue(7),
                                    Checked = reader.IntValue(8)
                                };
                                entityList.Add(temp);
                            }
                        }
