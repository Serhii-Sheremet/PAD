...
namespace PAD
{
    public partial class Sweph_Calc : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DateTime fromDate = new DateTime(2025, 1, 1), toDate = new DateTime(2026, 1, 1);
            ...
            List<MrityuBhagaData> mbDataList = eCalc.CalculateMrityuBhagaDataList_London(_mbList, EPlanet.RAHUMEAN, fromDate, toDate);
