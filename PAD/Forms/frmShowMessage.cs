...
namespace PAD
{
    public partial class frmShowMessage : Form
    {
        ...
        {
            get { return enumMessageButton.YesNo; }
            set { ButtonYesNo = value; }
        }
        public enumMessageButton ButtonOK
        {
            get { return enumMessageButton.OK; }
            set { ButtonOK = value; }
        }
        public enumMessageButton ButtonYesNoCancel
        {
            get { return enumMessageButton.YesNoCancel; }
            set { ButtonYesNoCancel = value; }
        }
        public enumMessageButton ButtonOKCancel
        {
            get { return enumMessageButton.OKCancel; }
            set { ButtonOKCancel = value; }
        }
        public enumMessageIcon IconError
        {
            get { return enumMessageIcon.Error; }
            set { IconError = value; }
        }
        public enumMessageIcon IconQuestion
        {
            get { return enumMessageIcon.Question; }
            set { IconQuestion = value; }
        }
        public enumMessageIcon IconInformation
        {
            get { return enumMessageIcon.Information; }
            set { IconInformation = value; }
        }
        public enumMessageIcon IconWarning
        {
            get { return enumMessageIcon.Warning; }
            set { IconWarning = value; }
        }
        #endregion
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            pictureBox1.BackColor = Color.Transparent; //Color.SkyBlue;
            base.OnPaint(e);
        }
        ...
        private void setMessage(string messageText)
        {
            ...
            if (number != 0)
                lblMessageText.Height = number * 30;*/
                ...
                case enumMessageButton.OK:
                    {
                        ...
                        btnOk.Text = Utility.GetLocalizedText("OK", (ELanguage)Utility.GetActiveLanguageCode(CacheLoad._appSettingList)); //"OK";  //Here we set text of Button.
                ...
                case enumMessageButton.OKCancel:
                    {
                        ...
                        btnOk.Text = Utility.GetLocalizedText("OK", (ELanguage)Utility.GetActiveLanguageCode(CacheLoad._appSettingList)); //"OK";
                        ...
                        btnCancel.Text = Utility.GetLocalizedText("Cancel", (ELanguage)Utility.GetActiveLanguageCode(CacheLoad._appSettingList)); //"Cancel";
                ...
                case enumMessageButton.YesNo:
                    {
                        ...
                        btnNo.Text = Utility.GetLocalizedText("No", (ELanguage)Utility.GetActiveLanguageCode(CacheLoad._appSettingList)); //"No";
                        ...
                        btnYes.Text = Utility.GetLocalizedText("Yes", (ELanguage)Utility.GetActiveLanguageCode(CacheLoad._appSettingList)); //"Yes";
        ...
        public static DialogResult Show(string messageText, string messageTitle, enumMessageIcon messageIcon, enumMessageButton messageButton)
        {
            frmShowMessage frmMessage = new frmShowMessage();
            frmMessage.setMessage(messageText);
            frmMessage.Text = messageTitle;
        ...
        public static DialogResult Show(string messageText, string messageTitle, enumMessageButton messageButton = enumMessageButton.YesNo, enumMessageIcon messageIcon = enumMessageIcon.Question)
        {
            frmShowMessage frmMessage = new frmShowMessage();
            frmMessage.setMessage(messageText);
            frmMessage.Text = messageTitle;
